...
<head>
    ...
    <style>
    body {
      background-image: url('assets/img/setyasyariah.jpg');
...
<body>
    {{-- <img src="assets/img/setyasyariah.jpg" class="background"> --}}
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">SYARIAH GROUP LOGIN</h1>
                                    </div>
